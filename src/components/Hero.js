...
const Hero = () => {
  return (
    <div className="bg-discord_blue pb-8 md:pb-3">
      <div className="p-12 py-9 h-screen md:h-[83vh] md:flex relative">
        ...
        <div className="flex-grow">
          <img
            src="https://i.ibb.co/0KK0S5r/e92fcc9ab6e63c1a17e954af347a1f1d.png"
            className="absolute -left-36 mt-16 sm:-left-44 md:hidden"
          />
          <img
            src="https://i.ibb.co/pQPgFDK/7b01f72a2054561145b6dd04add417c0.png"
            alt=""
            className="hidden md:inline md: absolute "
          />
        </div>
      </div>
    </div>
